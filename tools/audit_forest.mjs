...
import { TREE_SPECIES, TREE_VARIANTS, createForestDefs, treeDistribution, pickTreeType, forestSeed } from '../public/js/forest.js';
...
for (const def of Object.values(defs)) {
  ...
  for (const parts of def.variants) {
    assert.ok(parts.length <= 40, 'bounded per-variant draw calls');
...
console.log('Forest: 33 deterministic variants; connected geometry bounds; latitude/altitude probability sampling passed.');
