...
const ANCHORS_ALL = {
  ...
  // 地下道(②):馬德里 卡斯提亞大道一帶。實測 17 條地下道,取長度與 L1 兵線比例最合的兩條 ——
  // Calle de Joaquín Costa 覆蓋 165m @40.44554,-3.68581、Calle de María de Molina 覆蓋 234m
  // @40.43784,-3.68745(415m 那條 Agustín de Betancourt 會吃掉幾乎整條 481m 的兵線)。
  // 地形全平 ⇒ 深度只能來自「挖」,正是 underpassPlan 的適用面;PREFER_TUNNEL 讓選線踩上 tunnel way。
  madrid: [[40.44554, -3.68760], [40.43784, -3.68925]],
