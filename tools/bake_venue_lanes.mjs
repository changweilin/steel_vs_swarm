...
const ANCHORS_ALL = {
  ...
  // 錨點沿路軸退開 ~150m。**南路擺在前面**是刻意的:47m 的覆蓋段對 481m 的 L1 兵線
  // 比例剛好,228m 那條有近半條兵線在洞裡、砲塔容易埋進去觸發規則 #5(madrid 首輪前科);
  // 烘焙器挑錨點時本來就先比「規則 #4/#5 全合規的 L 數」⇒ 真的埋到塔會自動改用另一個錨。
  taoyuan: [[25.07614, 121.23121], [25.07791, 121.23260]],
