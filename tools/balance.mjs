...
import { CHARACTERS, UNITS, WEAPONS, GAME, SQUAD, ECON, ALTITUDE, chargeF, upgradePrice,
  armorMul, vsMult, heroWeapon, heroAbility, charKind, heroArmor, EVASION, evadable, weaponDps,
...
function fightWave(ch) {
  ...
  // 無人機恆飛行 → 移動中,對「吃閃避的攻擊」有 EVASION 閃避(範圍走 data.js 的 evadable 單一縫;
  // 2026-08-11 起爆炸傷害也在內 ⇒ 火箭兵那一份不再是必中);
