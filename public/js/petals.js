...
export const PETAL = {
  ...
  // ---- 運動 ----
  FALL_MIN: 0.32, FALL_MAX: 0.72,     // 落速帶(m/s);帶寬本身就是「有的飄有的墜」
  ORBIT_MIN: 0.04, ORBIT_MAX: 0.16,   // 繞場中心線的角速度(rad/s;正負各半 = 有順有逆)
  ...
  //      現值 2.655 / 0.45 = 5.9,離最近的 35/6 有 0.067。取整數比(4×、6×)看得出重複點。
  F_SLOW: 0.45, F_FAST: 2.655,
  SWAY_SLOW: 0.28, SWAY_FAST: 0.07, // 相對擺幅(佔軌道半徑);兩者相加 MUST < 1(半徑不得翻負)
  BOB: 0.16,                          // 快顫的垂直分量(m)
  SPIN_MIN: 0.5, SPIN_MAX: 1.8,       // 逐粒自轉角速度(rad/s)
