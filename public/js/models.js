...
const MOVE_SIG = {
  ...
  s03: { poise: 0.62, idleF: 0.48, idleA: 1.60, launch: 0.05, spool: 0.90, brake: 0.10, settle: 2.25, hover: 0.15, hoverF: 0.5, hoverA: 0.25, surge: 0.05, flare: 0.05, bank: 0.05 },  // 機械巨象護衛 ⟷ 浮空飛鯨
  ...
  s10: { poise: 0.80, idleF: 1.30, idleA: 0.50, launch: 0.84, spool: 0.16, brake: 0.40, settle: 0.90, hover: 0.22, hoverF: 0.75, hoverA: 0.65, surge: 0.38, flare: 0.75, bank: 0.52 },  // 迅猛龍蹲伏匿蹤 ⟷ 始祖鳥撲翼滑翔
...
const CAST_SIG = {
  ...
  s03: { omni: 'roar', dir: 'swing' },  // 巨象:昂鼻長鳴 + 象鼻橫掃
  ...
  s10: { omni: 'roar', dir: 'kick' },  // 迅猛龍:嘶鳴 + 鐮爪踢
