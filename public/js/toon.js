...
export const SOFT_KINDS = {
  ...
  // 樹幹/枝隨風搖曳(2026-09-02):amp 為 leaf 的一半,freq 與 axis 同 leaf ⇒ 幹梢與葉冠底部\r
  // 在**相同高度**上取到連續位移,接縫不會被風吹開。較低振幅讓幹視覺上比冠硬、但仍有彈性。\r
  wood:  { amp: 0.018, freq: 0.62, axis: 'y' },   // 樹幹 / 樹枝(amp = leaf 的一半)
