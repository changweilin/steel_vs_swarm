...
function enterGame() {
  ...
  $('pauseHelp').innerHTML = app.mySide
    ? (heroKind === 'drone'
      ? 'W/S 沿視線飛 ・ A/D 橫移 ・ Space/C 升降 ・ 左鍵 輕武器 ・ 右鍵切換 瞄準+重武器(準星鎖定) ・ Q 小招 ・ E 大招 ・ 狙擊模式長按左鍵 令兩架常駐護衛自殺機衝出(各半傷、3 倍速撲擊、吸走敵方導引飛彈,CD 30s、自爆後重現) ・ R 填彈 ・ B 升級 ・ 單機機動求生,善用護衛機拆塔清群!'
      : heroKind === 'morph'
      ? '地面:WASD 移動 ・ 按住 Space 蓄力 → 放開彈射變形飛行 ・ 飛行:W/S 沿視線飛、A/D 橫移、Space/C 升降、觸地變形回地面型 ・ 左鍵 輕武器 ・ 右鍵切換 瞄準+重武器 ・ Q 小招 ・ E 大招 ・ 狙擊模式長按左鍵 分離餌機(沿途投彈:依機體類型燃燒/凍結/毒霧/雷爆,有鎖定就追蹤,CD 30s) ・ R 填彈 ・ B 升級 ・ 地面小心地雷、高空小心防空!'
      : 'WASD 移動 ・ Space 跳 ・ Shift 衝刺 ・ 左鍵 輕武器 ・ 右鍵切換 瞄準+重武器 ・ Q 小招 ・ E 大招 ・ 狙擊模式長按左鍵 重砲模式(0.5s 傾洩剩餘彈夾、傷害 +33% 射程 +20%,CD 30s) ・ R 填彈 ・ B 升級 ・ 偏離兵線小心地雷!')
