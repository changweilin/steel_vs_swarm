...
export function buildGeneratedVesselMesh(v, { wake = true } = {}) {
  ...
  if(sub) {
    ...
    add('hull',loftGeometry([
      {z:-L/2,ring:ring(B*(fine?0.018:0.34),F,D*0.65)},
      {z:-L*0.32,ring:ring(B*0.5,F,D)},
      {z:L*0.23,ring:ring(B*0.5,F,D)},
      {z:L*0.43,ring:ring(B*(flat?0.39:0.25),F*1.08,D*0.7)},
      {z:L/2,ring:ring(B*(flat?0.32:0.015),F*1.12,D*0.16)},
    ]),hullMat);
    if(open) {
