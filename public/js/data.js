...
export const GAME = {
  ...
  // 狙擊模式中「長按右鍵」達此秒數 → 觸發機種專屬招(無人機護衛自殺機 / 機甲重砲 / 變形機甲餌機)。
  // 短按右鍵 = 切換一般/狙擊模式;達門檻才出招(觸發後放開不再切換,兩者不衝突),能力各有獨立 CD。
