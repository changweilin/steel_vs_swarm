...
// 「所有物件的最高高度限定 2 倍砲塔高度」。**尺只有一把 = `TARGET_H.tower`**:三個係數全是
...
export const WORLD_H = {
  OBJ_F: 2,          // 物件最高高度 = 2 × 砲塔高
  CEIL_AVG_F: 4,     // 天花板 = 平均海拔 + 4 × 砲塔高
  CEIL_PEAK_F: 2.5,  //     或 = 最高海拔 + 2.5 × 砲塔高,**取大者**
};
 ...
 * ⇒ 連最矮的一株都超過 2 倍砲塔高 ⇒ 硬夾之後整片森林**每一株一樣高**,而
