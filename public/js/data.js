...
export const CHARACTERS = {
  ...
  s01: {
    ...
    light: { name: '「弱起拍」六足分鍵機槍', rw: 'FN Minimi・初速 915m/s', type: 'gun', mv: 915,
      dmg: [11, 14, 17], rate: 10, mag: [40, 50, 60], reload: 2.0, range: 190, crit: 0.06,
      vs: { flesh: 1.2, armor: 0.6, air: 1.3, building: 0.5 } },
    heavy: { name: '「定音符」雷導火箭巢', rw: 'Hydra 70 + APKWS 雷射導引・初速 700m/s', type: 'launcher', mv: 700, guide: 1,
    ...
    skill: { name: '巴哈無伴奏', fx: 'buff', target: 'team', r: 180, mul: { dmg: [1.15, 1.23, 1.3] },
      ...
      dur: [6, 8, 10], cd: 20, mp: [35, 40, 45], desc: '起拍輕哼無伴奏:友軍火力提升,蜂群回收戰果(吸血)' },
    ult: { name: '總譜：終章大合奏', fx: 'summon', unit: 'heli', count: [2, 3, 4],
      cd: [80, 70, 60], mp: [80, 90, 100], desc: '揮落終曲總譜:呼叫攻擊直升機編隊沿最近兵線壓上' },
  },
  s02: {
    ...
    light: { name: '「老拖拉機」12.7mm 重機槍', rw: 'DShK・初速 850m/s', type: 'gun', mv: 850,
    ...
    heavy: { name: '「巴巴雅嘎」7V 溫壓破壁彈', rw: 'TBG-7V・初速 120m/s', type: 'launcher', mv: 120,
    ...
    skill: { name: '哈爾科夫補焊術', fx: 'heal', target: 'self', heal: [180, 260, 340],
      cd: [24, 21, 18], mp: [35, 40, 45], desc: '焊槍出手電弧飛濺:立即修復自身裝甲' },
    ult: { name: '「鐵匠鋪」爐火重鑄', fx: 'heal', target: 'team', r: 200, heal: [220, 300, 380], sp: true,
      cd: [80, 70, 60], mp: [85, 95, 105], desc: '全隊裝甲回火大修,護盾同步充滿' },
  },
  s03: {
    ...
    light: { name: '「半羽」相位波束槍', rw: '耳廓相控陣・光速直擊', type: 'beam',
    ...
    heavy: { name: '額隆 HPM 燒盾微波門', rw: 'HPM 定向能・光速', type: 'beam',
    ...
    ult: { name: '利維坦長波鯨歌', fx: 'emp', r: 260, dur: [4, 5, 6],
      cd: [70, 62, 54], mp: [90, 100, 110], desc: '全身隔艙稜線共形起振:大範圍低頻電子壓制' },
  },
  s04: {
    ...
    light: { name: '「普通科」九式貼臉霰彈莢', rw: 'Benelli M4・初速 400m/s', type: 'gun', mv: 400, fan: true, arc: [16, 14, 12],
      dmg: [34, 42, 52], rate: 2.2, mag: [7, 8, 10], reload: 2.6, range: 170, crit: 0.10, critX: 1.5,
      vs: { flesh: 1.6, armor: 0.5, air: 1.2, building: 0.4 } },
    heavy: { name: '「零式」熱浪電漿噴湧口', rw: '磁化電漿投射・扇形噴焰', type: 'plasma', arc: [13, 15, 17],
    ...
    ult: { name: '「遙控器沒電之時」', fx: 'buff', target: 'self', mul: { dmg: [1.35, 1.45, 1.55], dmgTaken: [0.85, 0.8, 0.75] },
      ...
      dur: [8, 10, 12], cd: [70, 60, 50], mp: [75, 85, 95], desc: '近接教官進入白刃戰反射狀態,突臉破陣' },
  },
  s05: {
    ...
    light: { name: '「天梯榜首」超導轉輪機關槍', rw: '實驗性線性感應馬達・初速 1400m/s', type: 'rail', mv: 1400,
      dmg: [9, 11, 14], rate: [14, 16, 18], mag: [70, 90, 110], reload: 2.8, range: 180, crit: 0.05,
      vs: { flesh: 1.2, armor: 0.6, air: 1.4, building: 0.4 } },
    heavy: { name: '「粉紅刺客」巡飛彈掛架', rw: 'Lancet 縮裝・巡飛 90m/s', type: 'missile', mv: 90,
  ...
  s06: {
    ...
    light: { name: '「冷爵士」磁軌點射步槍', rw: '實驗性磁軌步槍・初速 1600m/s', type: 'rail', mv: 1600,
    ...
    heavy: { name: '「救贖者」近程防空響尾蛇', rw: 'AIM-9X 縮裝・初速 1000m/s', type: 'missile', mv: 1000,
  ...
  s07: {
    ...
    light: { name: '「Q.E.D.」25mm 程控空爆砲', rw: 'XM25 派生・初速 760m/s', type: 'gun', mv: 760,
      dmg: [20, 25, 31], rate: 6, mag: [24, 30, 36], reload: 2.3, range: 210, crit: 0.06,
      vs: { flesh: 1.3, armor: 0.7, air: 1.6, building: 0.5 } },
    heavy: { name: '非歐幾何防空電漿網', rw: '磁化電漿・扇形防空散布', type: 'plasma', arc: [20, 23, 26],
  ...
  s08: {
    ...
    light: { name: '修道院守望 7.62 機槍', rw: 'PKM 7.62・初速 825m/s', type: 'gun', mv: 825,
      dmg: [14, 18, 22], rate: 7, mag: [36, 44, 52], reload: 2.1, range: 190, crit: 0.06,
      vs: { flesh: 1.3, armor: 0.7, air: 1.1, building: 0.5 } },
    heavy: { name: '「聖燭」電磁獵魔狙擊管', rw: '實驗性電磁狙擊系統・初速 2200m/s', type: 'rail', mv: 2200,
  ...
  s09: {
    ...
    light: { name: '「帕迪客製」12號雙管防空霰彈', rw: 'Purdey 12 鉛徑改・初速 420m/s', type: 'gun', mv: 420, fan: true, arc: [18, 16, 14],
      dmg: [34, 43, 53], rate: 2.6, mag: [8, 10, 12], reload: 2.4, range: 170, crit: 0.10, critX: 1.5,
      vs: { flesh: 1.3, armor: 0.4, air: 2.0, building: 0.3 } },
    heavy: { name: '「星光」星芒追獵飛彈', rw: 'Starstreak 縮裝・雷射波束導引・初速 300m/s', type: 'launcher', mv: 300, guide: 1,
  ...
  s10: {
    ...
    light: { name: '「白噪音」擾頻脈衝雷射', rw: '抑制型雷射訊號步槍・光速直擊', type: 'beam',
      dmg: [16, 20, 24], rate: 9, mag: [30, 36, 42], reload: 1.8, range: 220, crit: 0.08,
      vs: { flesh: 1.4, armor: 0.5, air: 1.1, building: 0.4 } },
    heavy: { name: '「DoS」電磁穿顱長矛', rw: 'EMP 狙擊彈・初速 900m/s', type: 'gun', mv: 900,
  ...
  s11: {
    ...
    light: { name: '「鐘錶軸心」聚焦雷射標槍', rw: '低散射固態雷射・光速直擊', type: 'beam',
    ...
    heavy: { name: '「擒縱器」膝關節碎裂磁軌砲', rw: '實驗性 EM 磁軌・初速 2000m/s', type: 'rail', mv: 2000,
  ...
  t01: {
    ...
    light: { name: '「科爾德」同軸守護重機槍', rw: 'Kord・初速 860m/s', type: 'gun', mv: 860,
    ...
    heavy: { name: '「2A65」152mm 破障加農砲', rw: '2A65 縮裝・初速 650m/s', type: 'launcher', mv: 650,
  ...
  t02: {
    ...
    light: { name: '「加拉泰亞」高斯脈衝衝鋒槍', rw: '實驗性 EM 線圈・初速 1100m/s', type: 'rail', mv: 1100,
      dmg: [14, 18, 21], rate: 8, mag: [32, 40, 48], reload: 1.9, range: 200, crit: 0.08,
      vs: { flesh: 1.2, armor: 0.9, air: 1.1, building: 0.5 } },
    heavy: { name: '「第七實驗體」高能磁軌穿甲矛', rw: 'EM 加速穿甲彈・初速 1500m/s', type: 'rail', mv: 1500,
  ...
  t03: {
    ...
    light: { name: '「主廚特調」12號連發碎肉霰彈', rw: 'Saiga-12 彈鼓・初速 400m/s', type: 'gun', mv: 400, fan: true, arc: [17, 15, 13],
      dmg: [36, 45, 56], rate: 2.4, mag: [8, 10, 12], reload: 2.6, range: 170, crit: 0.10, critX: 1.5,
      vs: { flesh: 1.6, armor: 0.6, air: 0.9, building: 0.5 } },
    heavy: { name: '「爐膛出火」重型電漿烈焰', rw: '磁化電漿投射・扇形噴焰', type: 'plasma', arc: [15, 17, 19],
  ...
  t04: {
    ...
    light: { name: '「微聲微光」9×39 特戰步槍', rw: 'VSS Vintorez 9×39・初速 295m/s', type: 'gun', mv: 295,
      dmg: [21, 27, 33], rate: 3.2, mag: [20, 24, 28], reload: 2.0, range: 210, crit: 0.15, critX: 1.8,
      vs: { flesh: 1.4, armor: 0.8, air: 1.0, building: 0.5 } },
    heavy: { name: '「格魯烏」14.5mm 穿甲反器材砲', rw: 'KPV・初速 1000m/s', type: 'gun', mv: 1000,
  ...
  t05: {
    ...
    light: { name: '「鶴羽一號」實驗型線圈步槍', rw: '實驗性線圈砲・初速 1500m/s', type: 'rail', mv: 1500,
      dmg: [16, 20, 25], rate: 7, mag: [36, 44, 52], reload: 2.1, range: 200, crit: 0.06,
      vs: { flesh: 1.3, armor: 0.8, air: 1.0, building: 0.5 } },
    heavy: { name: '「長空」仿生聚能雷射長矛', rw: '仿生關節整合雷射・光速直擊', type: 'beam',
  ...
  t06: {
    ...
    light: { name: '「山城特供」191 突擊步槍', rw: 'QBZ-191・初速 930m/s', type: 'gun', mv: 930,
      dmg: [15, 18, 23], rate: 9, mag: [34, 42, 50], reload: 1.8, range: 190, crit: 0.08,
      vs: { flesh: 1.3, armor: 0.7, air: 1.0, building: 0.5 } },
    heavy: { name: '「如意金箍」高溫熔核砲', rw: '磁化電漿聚爆・多節長尾前捲貼身直擊', type: 'plasma', arc: [10, 12, 14],
  ...
  t07: {
    ...
    light: { name: '「無聲」88 式微聲短卡賓', rw: '88 式縮裝・初速 720m/s', type: 'gun', mv: 720,
      dmg: [15, 19, 23], rate: 6, mag: [30, 36, 42], reload: 2.0, range: 190, crit: 0.10,
      vs: { flesh: 1.3, armor: 0.7, air: 1.0, building: 0.4 } },
    heavy: { name: '「白頭山鷹」14.5mm 栓動重狙', rw: '14.5mm 栓動・初速 1000m/s', type: 'gun', mv: 1000,
  ...
  t08: {
    ...
    light: { name: '「宮商和聲」光電脈衝步槍', rw: '聲電複合雷射・光速直擊', type: 'beam',
    ...
    heavy: { name: '「龍吟」護盾諧振音波砲', rw: '定向聲電複合・光速', type: 'beam',
  ...
  t09: {
    ...
    light: { name: '「魯米之章」防衛機槍', rw: 'MG3 7.62・初速 820m/s', type: 'gun', mv: 820,
      dmg: [14, 18, 22], rate: 8, mag: [40, 48, 56], reload: 2.2, range: 190, crit: 0.06,
      vs: { flesh: 1.3, armor: 0.7, air: 1.0, building: 0.5 } },
    heavy: { name: '「見證者」136 巡飛彈發射槽', rw: 'Shahed 縮裝・巡飛 100m/s', type: 'missile', mv: 100,
  ...
  t10: {
    ...
    light: { name: '「伊斯法罕」30mm 截擊速射砲', rw: '2A42 縮裝・初速 960m/s', type: 'gun', mv: 960,
      dmg: [18, 22, 27], rate: 5.5, mag: [28, 34, 40], reload: 2.3, range: 210, pen: 6,
      vs: { flesh: 1.1, armor: 1.0, air: 1.5, building: 0.5 } },
    heavy: { name: '「道爾」垂直冷發射防空飛彈', rw: '9M330 縮裝・初速 800m/s', type: 'missile', mv: 800,
  ...
  t11: {
    ...
    light: { name: '「哈瓦那」老式 12.7mm 重機槍', rw: 'DShKM・初速 850m/s', type: 'gun', mv: 850,
      dmg: [20, 25, 31], rate: 4.8, mag: [34, 40, 48], reload: 2.3, range: 200, pen: 4,
      vs: { flesh: 1.3, armor: 1.0, air: 0.8, building: 0.6 } },
    heavy: { name: '「老雪茄」SPG-9 破甲無後座力砲', rw: 'SPG-9・初速 435m/s', type: 'launcher', mv: 435,
  ...
  t12: {
    ...
    light: { name: '「螢光尋跡」相位雷射槍', rw: '低功率相位雷射・光速直擊', type: 'beam',
      dmg: [13, 16, 20], rate: 10, mag: [40, 50, 60], reload: 1.8, range: 220, crit: 0.08,
      vs: { flesh: 1.3, armor: 0.5, air: 1.0, building: 0.4 } },
    heavy: { name: '「深層日誌」EM 標定電磁砲', rw: 'EM 標定彈・初速 2500m/s', type: 'rail', mv: 2500,
...
//       m05 jet↔wolf(趾行深屈・鬃刺肩尖)
  ...
  m01: {
    ...
    light: { name: '「火神」7.62mm 六管轉輪機槍', rw: 'M134 Minigun・初速 850m/s', type: 'gun', mv: 850,
    ...
    heavy: { name: '「地獄火」穿盾雷射導引彈', rw: 'AGM-114 縮裝・鎖定追蹤・初速 450m/s', type: 'missile', mv: 450,
  ...
  m02: {
    ...
    light: { name: '「憲兵隊」通用機關槍', rw: 'FN MAG・初速 840m/s', type: 'gun', mv: 840,
      dmg: [16, 20, 25], rate: 7, mag: [40, 48, 56], reload: 2.2, range: 195, crit: 0.05,
      vs: { flesh: 1.3, armor: 0.8, air: 0.9, building: 0.5 } },
    heavy: { name: '「巨顎」口藏重型線圈加農砲', rw: '大口徑線性馬達砲・初速 1800m/s', type: 'rail', mv: 1800,
  ...
  m03: {
    ...
    light: { name: '「雪線」防衛脈衝雷射', rw: '低功率防禦雷射・光速直擊', type: 'beam',
      dmg: [15, 19, 23], rate: 8, mag: [30, 36, 42], reload: 1.9, range: 220, crit: 0.07,
      vs: { flesh: 1.4, armor: 0.5, air: 1.1, building: 0.4 } },
    heavy: { name: '「精算師」雷射導引空投彈', rw: 'APKWS 雷射導引・初速 700m/s', type: 'launcher', mv: 700, guide: 1,
  ...
  m04: {
    ...
    light: { name: '「阿爾泰」微聲戰鬥步槍', rw: 'HK G28・初速 780m/s', type: 'gun', mv: 780,
      dmg: [17, 21, 25], rate: 3.6, mag: [20, 24, 28], reload: 2.0, range: 215, crit: 0.14, critX: 1.8,
      vs: { flesh: 1.3, armor: 0.8, air: 1.1, building: 0.5 } },
    heavy: { name: '「金鵰之爪」20mm 反器材重砲', rw: '20mm 市購反器材砲・初速 900m/s', type: 'gun', mv: 900,
  ...
  m05: {
    ...
    light: { name: '「鎖喉」12.7mm 三管電磁機砲', rw: 'GAU-19 線圈化改裝・初速 1300m/s', type: 'rail', mv: 1300,
      dmg: [19, 24, 30], rate: 6, mag: [36, 44, 52], reload: 2.4, range: 200, crit: 0.06,
      vs: { flesh: 1.2, armor: 1.0, air: 0.9, building: 0.6 } },
    heavy: { name: '「債務催收」自導飛彈', rw: '射後鎖定制導彈・初速 400m/s', type: 'missile', mv: 400,
  ...
  m06: {
    ...
    light: { name: '「里約放克」雙聯掛架機槍', rw: 'PKP 縮裝・初速 825m/s', type: 'gun', mv: 825,
      dmg: [13, 16, 20], rate: 9, mag: [45, 54, 63], reload: 2.2, range: 180, crit: 0.05,
      vs: { flesh: 1.3, armor: 0.6, air: 1.2, building: 0.5 } },
    heavy: { name: '「嘉年華彩花」集束子母彈', rw: 'CBU 縮裝・初速 400m/s', type: 'launcher', mv: 400,
  ...
  m07: {
    ...
    light: { name: '「界碑」雙聯 35mm 厄利孔高射砲', rw: 'Oerlikon 縮裝・初速 1100m/s', type: 'gun', mv: 1100,
      dmg: [18, 23, 28], rate: 6.5, mag: [32, 40, 48], reload: 2.6, range: 210, crit: 0.05,
      vs: { flesh: 1.0, armor: 0.9, air: 1.6, building: 0.5 } },
    heavy: { name: '「落閘」扇面防衛電漿幕', rw: '近迫電漿散射・扇形攔截', type: 'plasma', arc: [22, 25, 28],
