...
> Layer 2: topic-to-guard mapping only. Principles live in root `AGENTS.md`; full definitions live in `seams-*` and `antipatterns.md`; assertion details live in audit script headers (layer 4).
