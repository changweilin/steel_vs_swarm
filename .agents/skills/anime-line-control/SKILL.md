...
its `AGENTS.md` trap table and `NEXT.md` carry as much as the code does.
...
| What geometry does to line density | sakura — `AGENTS.md` trap table, the rows on canopies, thin meshes and `geometry.groups` |
