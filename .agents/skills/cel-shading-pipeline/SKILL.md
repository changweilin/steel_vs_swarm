...
the history; its `AGENTS.md` trap table and `NEXT.md` carry as much as the code does.
...
| The geometry-side discipline table, with the symptom each row was written from | sakura — `AGENTS.md`, "Traps that have already bitten" |
