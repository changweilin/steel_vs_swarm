...
> Procedural generation is the **default** here, not the fallback: `AGENTS.md` §1 pairs
> `MODEL_MANIFEST` with a procedural fallback, and `.Codex/skills/procedural-object-detail`
