...
| The "reads-as" failures in this skill, each with the frame it was reported from | sakura — `AGENTS.md` trap table (reeds, crows, willow fronds, conifer whorls, water panels) |
